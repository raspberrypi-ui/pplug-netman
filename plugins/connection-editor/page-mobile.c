                       ...
                       gpointer user_data)
{
	...
	gtk_window_set_icon_name (GTK_WINDOW (dialog), "network-cellular-connected");
	...
	image = gtk_image_new_from_icon_name ("network-cellular-connected", GTK_ICON_SIZE_DIALOG);
